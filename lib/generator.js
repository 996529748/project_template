...
class Generator {
    ...
    async getRepo() {
        ...
        return await inquirer.prompt([
            ...
            switch (answer.name) {
                case 'vue2':
                    url = 'direct:https://github.com/996529748/project_template.git#vue2'
                    break;
                case 'gulp4':
                    url = 'direct:https://github.com/996529748/project_template.git#gulp4'
                    break;
                case 'vue3':
                    url = 'direct:https://github.com/996529748/project_template.git#vue3_ts_vant_mobile'
                    break;
            }
